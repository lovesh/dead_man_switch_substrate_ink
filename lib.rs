...
mod dead_man_switch {
    ...
    mod tests {
        ...
        fn default_works() {
            ...
            let dead_man_switch = DeadManSwitch::default();
            assert_eq!(dead_man_switch.get(), false);
        }

        /// We test a simple use case of our contract.
        #[test]
        fn it_works() {
            let mut dead_man_switch = DeadManSwitch::new(false);
            assert_eq!(dead_man_switch.get(), false);
            dead_man_switch.flip();
            assert_eq!(dead_man_switch.get(), true);
        }
    }
}
